...
import 'package:flutter_application/core/providers/datetime/datetime.provider.dart';
...
final dateTimeProvider = StateNotifierProvider<DateTimeProvider, DateTime>(
  (ref) => DateTimeProvider(),
);
