...
abstract class RouteService {
  Future<void> push(PageRouteInfo<dynamic> route, BuildContext context);
...
class RouteServiceImpl implements RouteService {
  @override
  Future<void> push(PageRouteInfo<dynamic> route, BuildContext context) async {
    await context.router.push(route, onFailure: (NavigationFailure failure) {});
  }
